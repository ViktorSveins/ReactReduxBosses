...
class EditBoss extends React.Component {
    ...
    submitForm(e) {
        ...
        if (this.validateForm()) {
            this.props.editBoss(this.state.fields);
            this.handleClose();
        } else {
            toastr.error('Boss could not be edited!', 'Failed!');
        }
    }
    ...
    render() {
        ...
        return (
            <>
                <Button variant="warning" onClick={this.handleShow} style={{float: 'right'}}>
                    Edit
                </Button>
                
                <Modal show={this.state.show} onHide={this.handleClose}>
                    <Modal.Header closeButton>
                        <Modal.Title>Edit { boss.name }!</Modal.Title>
                    </Modal.Header>
...
export default connect(mapStateToProps, { editBoss })(EditBoss);